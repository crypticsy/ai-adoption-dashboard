...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r ${color === 'blue' ? 'from-blue-500 to-cyan-500' : color === 'purple' ? 'from-purple-500 to-pink-500' : color === 'green' ? 'from-green-500 to-emerald-500' : color === 'orange' ? 'from-orange-500 to-yellow-500' : 'from-red-500 to-rose-500'}`}
        initial={{ width: 0 }}
        animate={{ width: '100%' }}
